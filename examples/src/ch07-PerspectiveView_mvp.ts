...
class PerspectiveView_mvp {
  constructor() {
    ...
    var modelMatrix = new cuonMatix.Matrix4(); // The model matrix
    var viewMatrix = new cuonMatix.Matrix4();  // The view matrix
    var projMatrix = new cuonMatix.Matrix4();  // The projection matrix
