...
class SpecularCube {
  constructor() {
    ...
    var tick = () => {
      ...
      this.drawCommon(gl, canvas, angle, perspectiveMatrixShaderLocation, viewMatrixShaderLocation, lightPositionShaderLocation, f_viewMatrixShaderLocation);

      this.drawCube(gl, canvas, angle, perspectiveMatrixShaderLocation, modelMatrixShaderLocation, lightPositionShaderLocation);
    };
    tick();
  }
