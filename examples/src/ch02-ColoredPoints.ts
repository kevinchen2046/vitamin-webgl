...
class ColoredPoints {
    ...
    constructor() {
        ...
        canvas.onmousedown = (ev) => { this.click(ev, gl, canvas, a_Position, u_FragColor) };
    ...
    private g_points = [];  // The array for the position of a mouse press
    private g_colors = [];  // The array to store the color of a point
