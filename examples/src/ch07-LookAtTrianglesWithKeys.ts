...
class LookAtTrianglesWithKeys {
  constructor() {
    ...
    document.onkeydown = (ev) => { this.keydown(ev, gl, n, u_ViewMatrix, viewMatrix); };
  ...
  private g_eyeX = 0.20;
  private g_eyeY = 0.25;
  private g_eyeZ = 0.25; // Eye position
  keydown(ev, gl, n, u_ViewMatrix: WebGLUniformLocation, viewMatrix: cuonMatix.Matrix4) {
  ...
  draw(gl, n, u_ViewMatrix: WebGLUniformLocation, viewMatrix: cuonMatix.Matrix4) {
