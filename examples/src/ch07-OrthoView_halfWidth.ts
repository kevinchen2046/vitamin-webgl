...
class OrthoView_halfWidth {
  constructor() {
    ...
    document.onkeydown = (ev) => { this.keydown(ev, gl, n, u_ProjMatrix, projMatrix, nf); };
  ...
  keydown(ev, gl, n, u_ProjMatrix, projMatrix, nf) {
    switch (ev.keyCode) {
      case 39: this.g_near += 0.01; break;  // The right arrow key was pressed
      case 37: this.g_near -= 0.01; break;  // The left arrow key was pressed
      case 38: this.g_far += 0.01; break;  // The up arrow key was pressed
      case 40: this.g_far -= 0.01; break;  // The down arrow key was pressed
