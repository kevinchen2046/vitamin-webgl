...
var g_perspectiveMatrix = new cuonMatix.Matrix4();
var g_lightDir = new Utils.Vector3([0, 0.4, 0.6]);
var g_modelMatrix = new cuonMatix.Matrix4();
var g_viewMatrix = new cuonMatix.Matrix4();
...
class Particle {
  constructor() {
    ...
    var tick = () => {
      ...
      this.drawCommon(gl, canvas, perspectiveMatrixShaderLocation, viewMatrixShaderLocation, lightDirShaderLocation);
      this.drawParticle(gl, particle, perspectiveMatrixShaderLocation, modelMatrixShaderLocation, textureSamplerShaderLocation, alphaShaderLocation);
    };
    tick();
  }
  ...
  drawParticle(gl, p, perspectiveMatrixShaderLocation, modelMatrixShaderLocation, textureSamplerShaderLocation, alphaShaderLocation) {
  ...
  initTextures(gl, str) {
    ...
    IMAGE.onload = () => { this.loadTexture(gl, TEXTURE, IMAGE); };
    IMAGE.src = str;
