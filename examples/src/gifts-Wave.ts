...
class Wave {
  constructor() {
    ...
    var tick = () => {
      ...
      this.drawCommon(gl, canvas, perspectiveMatrixShaderLocation, viewMatrixShaderLocation);
      this.drawGrid(gl, perspectiveMatrixShaderLocation, modelMatrixShaderLocation);
    };
    tick();
  }
