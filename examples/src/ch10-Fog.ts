...
class Fog {
  constructor() {
    ...
    document.onkeydown = (ev) => { this.keydown(ev, gl, n, u_FogDist, fogDist); };
    ...
    var modelViewMatrix = new cuonMatix.Matrix4();
  ...
  initVertexBuffers(gl) {
    ...
    if (!this.initArrayBuffer(gl, vertices, 3, gl.FLOAT, 'a_Position')) return -1;
    if (!this.initArrayBuffer(gl, colors, 3, gl.FLOAT, 'a_Color')) return -1;
