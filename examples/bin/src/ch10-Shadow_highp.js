...
var Shadow_highp = /** @class */ (function () {
    function Shadow_highp() {
        var _this = this;
        ...
        var tick = function () {
            ...
            _this.drawPlane(gl, shadowProgram, plane, viewProjMatrixFromLight);
            ...
            _this.drawPlane(gl, normalProgram, plane, viewProjMatrix);
            window.requestAnimationFrame(tick);
        };
        tick();
    }
    Shadow_highp.prototype.drawTriangle = function (gl, program, triangle, angle, viewProjMatrix) {
    ...
    Shadow_highp.prototype.drawPlane = function (gl, program, plane, viewProjMatrix) {
        // Set rotate angle to model matrix and draw plane
        this.g_modelMatrix.setRotate(-45, 0, 1, 1);
        this.draw(gl, program, plane, viewProjMatrix);
    };
    Shadow_highp.prototype.draw = function (gl, program, o, viewProjMatrix) {
    ...
    Shadow_highp.prototype.initAttributeVariable = function (gl, a_attribute, buffer) {
        gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
        gl.vertexAttribPointer(a_attribute, buffer.num, buffer.type, false, 0, 0);
        gl.enableVertexAttribArray(a_attribute);
    };
    Shadow_highp.prototype.initVertexBuffersForPlane = function (gl) {
        // Create a plane
        //  v1------v0
        //  |        | 
        //  |        |
    ...
    Shadow_highp.prototype.initVertexBuffersForTriangle = function (gl) {
        // Create a triangle
        //       v2
        //      / | 
        //     /  |
    ...
    Shadow_highp.prototype.initArrayBufferForLaterUse = function (gl, data, num, type) {
    ...
    Shadow_highp.prototype.initElementArrayBufferForLaterUse = function (gl, data, type) {
        // Create a buffer object
        var buffer = gl.createBuffer();
        if (!buffer) {
            console.log('Failed to create the buffer object');
    ...
    Shadow_highp.prototype.initFramebufferObject = function (gl) {
    ...
    Shadow_highp.prototype.animate = function (angle) {
...
//# sourceMappingURL=ch10-Shadow_highp.js.map