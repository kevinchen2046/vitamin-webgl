...
var Wave = /** @class */ (function () {
    function Wave() {
        ...
        this.sendGridVertexBuffers(gl);
        var time = 0;
        var tick = function () {
            window.requestAnimationFrame(tick);
            time += 0.02;
            gl.uniform1f(timeShaderLocation, time);
            _this.drawCommon(gl, canvas, perspectiveMatrixShaderLocation, viewMatrixShaderLocation);
            _this.drawGrid(gl, perspectiveMatrixShaderLocation, modelMatrixShaderLocation);
        };
        tick();
    }
    Wave.prototype.drawCommon = function (gl, canvas, perspectiveMatrixShaderLocation, viewMatrixShaderLocation) {
    ...
    Wave.prototype.drawGrid = function (gl, perspectiveMatrixShaderLocation, modelMatrixShaderLocation) {
    ...
    Wave.prototype.sendGridVertexBuffers = function (gl) {
        var positionData = [];
        var indexData = [];
        var xnum = 200;
        var znum = 200;
...
//# sourceMappingURL=gifts-Wave.js.map