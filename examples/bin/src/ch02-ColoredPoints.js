...
var FSHADER_SOURCE = 'precision mediump float;\n' +
    ...
    '}\n';
var ColoredPoints = /** @class */ (function () {
    function ColoredPoints() {
        ...
        canvas.onmousedown = function (ev) { _this.click(ev, gl, canvas, a_Position, u_FragColor); };
        // Specify the color for clearing <canvas>
        gl.clearColor(0.0, 0.0, 0.0, 1.0);
        // Clear <canvas>
        gl.clear(gl.COLOR_BUFFER_BIT);
    }
    ColoredPoints.prototype.click = function (ev, gl, canvas, a_Position, u_FragColor) {
...
//# sourceMappingURL=ch02-ColoredPoints.js.map