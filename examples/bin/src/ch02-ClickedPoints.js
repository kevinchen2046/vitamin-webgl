...
var FSHADER_SOURCE = 'void main() {\n' +
    ...
    '}\n';
var ClickedPoints = /** @class */ (function () {
    function ClickedPoints() {
        ...
        canvas.onmousedown = function (ev) { _this.click(ev, gl, canvas, a_Position); };
        // Specify the color for clearing <canvas>
        gl.clearColor(0.0, 0.0, 0.0, 1.0);
        // Clear <canvas>
        gl.clear(gl.COLOR_BUFFER_BIT);
    }
    ClickedPoints.prototype.click = function (ev, gl, canvas, a_Position) {
...
//# sourceMappingURL=ch02-ClickedPoints.js.map