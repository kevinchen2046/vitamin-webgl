...
var FSHADER_SOURCE = 'precision mediump float;\n' +
    ...
    '}\n';
var TextTexture = /** @class */ (function () {
    function TextTexture() {
        ...
        // Initialize shaders
        if (!Utils.initShaders(gl, VSHADER_SOURCE, FSHADER_SOURCE, ['a_Position', 'a_TexCoord'])) {
            console.log('Failed to initialize shaders');
            return;
        }
        // Set the vertex information
        if (!this.initVertexBuffers(gl)) {
    ...
    TextTexture.prototype.initVertexBuffers = function (gl) {
        var positions = [
            -0.5, 0.5,
            -0.5, -0.5,
            0.5, 0.5,
    ...
    TextTexture.prototype.initTextures = function (gl) {
    ...
    TextTexture.prototype.draw = function (gl) {
...
//# sourceMappingURL=gifts-TextTexture.js.map