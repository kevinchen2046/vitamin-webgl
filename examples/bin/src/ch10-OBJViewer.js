...
var OBJViewer = /** @class */ (function () {
    function OBJViewer() {
        ...
        var tick = function () {
            ...
            _this.draw(gl, gl.program, currentAngle, viewProjMatrix, model);
            requestAnimationFrame(tick);
        };
        tick();
    }
    // Create an buffer object and perform an initial configuration
    OBJViewer.prototype.initVertexBuffers = function (gl, program) {
    ...
    OBJViewer.prototype.createEmptyArrayBuffer = function (gl, a_attribute, num, type) {
    ...
    // Read a file
    OBJViewer.prototype.readOBJFile = function (fileName, gl, model, scale, reverse) {
        var _this = this;
        var request = new XMLHttpRequest();
        request.onreadystatechange = function () {
            if (request.readyState === 4 && request.status !== 404) {
                _this.onReadOBJFile(request.responseText, fileName, gl, model, scale, reverse);
            }
        };
    ...
    OBJViewer.prototype.onReadOBJFile = function (fileString, fileName, gl, o, scale, reverse) {
    ...
    // 描画関数
    OBJViewer.prototype.draw = function (gl, program, angle, viewProjMatrix, model) {
        if (g_objDoc != null && g_objDoc.isMTLComplete()) { // OBJ and all MTLs are available
            this.g_drawingInfo = this.onReadComplete(gl, model, g_objDoc);
            g_objDoc = null;
        }
    ...
    OBJViewer.prototype.onReadComplete = function (gl, model, objDoc) {
    ...
    OBJViewer.prototype.animate = function (angle) {
...
//# sourceMappingURL=ch10-OBJViewer.js.map