...
var HUD = /** @class */ (function () {
    function HUD() {
        ...
        var tick = function () {
            ...
            _this.draw2D(ctx, currentAngle); // Draw 2D
            _this.draw(gl, n, currentAngle, viewProjMatrix, u_MvpMatrix);
            requestAnimationFrame(tick);
        };
        tick();
    }
    HUD.prototype.initVertexBuffers = function (gl) {
        // Create a cube
        //    v6----- v5
        //   /|      /|
        //  v1------v0|
    ...
    HUD.prototype.check = function (gl, n, x, y, currentAngle, u_Clicked, viewProjMatrix, u_MvpMatrix) {
        var picked = false;
    ...
    HUD.prototype.draw = function (gl, n, currentAngle, viewProjMatrix, u_MvpMatrix) {
    ...
    HUD.prototype.draw2D = function (ctx, currentAngle) {
    ...
    HUD.prototype.animate = function (angle) {
    ...
    HUD.prototype.initArrayBuffer = function (gl, data, num, type, attribute) {
        // Create a buffer object
...
//# sourceMappingURL=ch10-HUD.js.map