...
var FSHADER_SOURCE = '#ifdef GL_ES\n' +
    ...
    '}\n';
var BlendedCube = /** @class */ (function () {
    function BlendedCube() {
    ...
    BlendedCube.prototype.initVertexBuffers = function (gl) {
        // Create a cube
        //    v6----- v5
        //   /|      /|
        //  v1------v0|
        ...
        if (!this.initArrayBuffer(gl, vertices, 3, gl.FLOAT, 'a_Position'))
            return -1;
        if (!this.initArrayBuffer(gl, colors, 4, gl.FLOAT, 'a_Color'))
            return -1;
    ...
    BlendedCube.prototype.initArrayBuffer = function (gl, data, num, type, attribute) {
        // Create a buffer object
...
//# sourceMappingURL=ch10-BlendedCube.js.map