...
var ThreeDoverWeb = /** @class */ (function () {
    function ThreeDoverWeb() {
        var _this = this;
        ...
        canvas.onmousedown = function (ev) {
            ...
            if (rect.left <= x && x < rect.right && rect.top <= y && y < rect.bottom) {
                ...
                _this.check(gl, n, x_in_canvas, y_in_canvas, currentAngle, u_Clicked, viewProjMatrix, u_MvpMatrix);
            }
        };
        var tick = function () {
    ...
    ThreeDoverWeb.prototype.initVertexBuffers = function (gl) {
        // Create a cube
        //    v6----- v5
        //   /|      /|
        //  v1------v0|
    ...
    ThreeDoverWeb.prototype.check = function (gl, n, x, y, currentAngle, u_Clicked, viewProjMatrix, u_MvpMatrix) {
        var picked = false;
    ...
    ThreeDoverWeb.prototype.draw = function (gl, n, currentAngle, viewProjMatrix, u_MvpMatrix) {
    ...
    ThreeDoverWeb.prototype.animate = function (angle) {
    ...
    ThreeDoverWeb.prototype.initArrayBuffer = function (gl, data, type, num, attribute) {
        // Create a buffer object
    ...
    return ThreeDoverWeb;
}());
//# sourceMappingURL=ch10-ThreeDoverWeb.js.map