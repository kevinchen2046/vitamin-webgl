...
var FSHADER_SOURCE = '#ifdef GL_ES\n' +
    ...
    '}\n';
var PerspectiveView_mvp = /** @class */ (function () {
    function PerspectiveView_mvp() {
        ...
        var modelMatrix = new Utils.Matrix4(); // The model matrix
        var viewMatrix = new Utils.Matrix4(); // The view matrix
        var projMatrix = new Utils.Matrix4(); // The projection matrix
    ...
    PerspectiveView_mvp.prototype.initVertexBuffers = function (gl) {
    ...
    return PerspectiveView_mvp;
}());
//# sourceMappingURL=ch07-PerspectiveView_mvp.js.map