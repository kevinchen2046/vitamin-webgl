...
var FSHADER_SOURCE = '#ifdef GL_ES\n' +
    ...
    '}\n';
var OrthoView_halfWidth = /** @class */ (function () {
    function OrthoView_halfWidth() {
        var _this = this;
        ...
        this.draw(gl, n, u_ProjMatrix, projMatrix, nf); // Draw
    }
    OrthoView_halfWidth.prototype.initVertexBuffers = function (gl) {
    ...
    OrthoView_halfWidth.prototype.keydown = function (ev, gl, n, u_ProjMatrix, projMatrix, nf) {
        switch (ev.keyCode) {
            case 39:
                this.g_near += 0.01;
    ...
    OrthoView_halfWidth.prototype.draw = function (gl, n, u_ProjMatrix, projMatrix, nf) {
        // Specify the viewing volume
        projMatrix.setOrtho(-0.3, 0.3, -1.0, 1.0, this.g_near, this.g_far);
    ...
    return OrthoView_halfWidth;
}());
//# sourceMappingURL=ch07-OrthoView_halfWidth.js.map