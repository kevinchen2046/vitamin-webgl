...
MQODoc.prototype.readObjects = function () {
    ...
    while (line = this.lines[this.index++]) {
        if (line.indexOf('facet') >= 0)
            continue; // Skip this line because "face" is substring of "facet"
        if (line.indexOf('color_type') >= 0)
            continue; // Skip this line because "color" is substring of "color_type"
...
//# sourceMappingURL=ch10-MQOParser.js.map