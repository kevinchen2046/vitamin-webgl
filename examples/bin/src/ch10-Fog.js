...
var Fog = /** @class */ (function () {
    function Fog() {
        ...
        document.onkeydown = function (ev) { _this.keydown(ev, gl, n, u_FogDist, fogDist); };
        // Clear color and depth buffer
        gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
        // Draw
        gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
        var modelViewMatrix = new Utils.Matrix4();
        modelViewMatrix.setLookAt(eye[0], eye[1], eye[2], 0, 2, 0, 0, 1, 0);
        modelViewMatrix.multiply(modelMatrix);
        modelViewMatrix.multiplyVector4(new Utils.Vector4([1, 1, 1, 1]));
        mvpMatrix.multiplyVector4(new Utils.Vector4([1, 1, 1, 1]));
        modelViewMatrix.multiplyVector4(new Utils.Vector4([-1, 1, 1, 1]));
        mvpMatrix.multiplyVector4(new Utils.Vector4([-1, 1, 1, 1]));
    }
    Fog.prototype.keydown = function (ev, gl, n, u_FogDist, fogDist) {
        switch (ev.keyCode) {
    ...
    Fog.prototype.initVertexBuffers = function (gl) {
        // Create a cube
        //    v6----- v5
        //   /|      /|
        //  v1------v0|
    ...
    Fog.prototype.initArrayBuffer = function (gl, data, num, type, attribute) {
        // Create a buffer object
...
//# sourceMappingURL=ch10-Fog.js.map