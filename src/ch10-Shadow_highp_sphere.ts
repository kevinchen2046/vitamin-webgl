...
class Shadow_highp_sphere {
  constructor() {
    ...
    var tick = () => {
      ...
      this.drawTriangle(gl, shadowProgram, triangle, currentAngle, viewProjMatrixFromLight);
      mvpMatrixFromLight_t.set(this.g_mvpMatrix); // Used later
      this.drawSphere(gl, shadowProgram, sphere, viewProjMatrixFromLight);
      mvpMatrixFromLight_p.set(this.g_mvpMatrix); // Used later
      ...
      this.drawTriangle(gl, normalProgram, triangle, currentAngle, viewProjMatrix);
      gl.uniformMatrix4fv(normalProgram.u_MvpMatrixFromLight, false, mvpMatrixFromLight_p.elements);
      this.drawSphere(gl, normalProgram, sphere, viewProjMatrix);
  ...
  private g_modelMatrix = new Utils.Matrix4();
  private g_mvpMatrix = new Utils.Matrix4();
  drawTriangle(gl, program, triangle, angle, viewProjMatrix) {
  ...
  drawSphere(gl, program, sphere, viewProjMatrix) {
  ...
  initVertexBuffersForSphere(gl) { // Create a sphere
    var SPHERE_DIV = 20;
    ...
    var o: any = new Object(); // Utilize Object object to return multiple buffer objects together
  ...
  initVertexBuffersForTriangle(gl) {
    // Create a triangle
    //       v2
    //      / | 
    //     /  |
  ...
  private ANGLE_STEP = 40;   // The increments of rotation angle (degrees)
